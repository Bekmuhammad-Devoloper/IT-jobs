    ...
    <div style={{paddingBottom:100,minHeight:'100dvh'}}>
      ...
      <div className="anim-fade" style={{padding:'20px 16px',display:'flex',flexDirection:'column',gap:16}}>
        ...
        <div style={{display:'flex',flexWrap:'wrap',gap:6}}>
          ...
          {post.type === 'MENTOR' && (post.extra as any)?.durationHours && <Chip svg={<svg width="13" height="13" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><path d="M12 6v6l4 2"/></svg>} text={`${(post.extra as any).durationHours} soat`} />}
          {post.type === 'MENTOR' && (post.extra as any)?.daysPerWeek && <Chip svg={<svg width="13" height="13" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24"><rect x="3" y="4" width="18" height="18" rx="2"/><path d="M16 2v4M8 2v4M3 10h18"/></svg>} text={`${(post.extra as any).daysPerWeek} kun/hafta`} />}
          {post.type === 'MENTOR' && (post.extra as any)?.months && <Chip svg={<svg width="13" height="13" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24"><rect x="3" y="4" width="18" height="18" rx="2"/><path d="M16 2v4M8 2v4M3 10h18M8 14h2M14 14h2M8 18h2M14 18h2"/></svg>} text={`${(post.extra as any).months} oy`} />}
        </div>
