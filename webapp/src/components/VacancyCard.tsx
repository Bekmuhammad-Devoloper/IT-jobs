    ...
    <Link href={`/posts/${post.id}`} style={{ display: 'block', textDecoration: 'none' }}>
      <article
        ...
        style={{
          ...
          animation: `vacancyFloatIn 700ms cubic-bezier(0.22, 1, 0.36, 1) ${index * 80}ms both`,
          cursor: 'pointer',
        }}
        onMouseEnter={(e) => {
          const el = e.currentTarget;
          el.style.transform = 'translateY(-6px)';
          el.style.boxShadow = '0 24px 48px hsla(160, 84%, 39%, 0.15), 0 0 0 1px hsla(160, 84%, 39%, 0.3)';
        }}
        onMouseLeave={(e) => {
          const el = e.currentTarget;
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 14 }}>
          <span
            style={{
              ...
              padding: '6px 16px',
              borderRadius: 9999,
              boxShadow: '0 4px 14px hsla(160, 84%, 39%, 0.5)',
              whiteSpace: 'nowrap',
            }}
          >
            Vakansiya
